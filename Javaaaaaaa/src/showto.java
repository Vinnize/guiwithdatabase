 ...
 * @author vinnize
 */
public class showto extends javax.swing.JFrame {

    /**
     * Creates new form showto
     */
    public showto() {
        initComponents();
        fetch();
   ...
   String url = "jdbc:derby://localhost:1527/C:/Derby/mydb";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
