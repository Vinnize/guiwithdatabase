 ...
 * @author vinnize
 */
public class showtc extends javax.swing.JFrame {

    /**
     * Creates new form showtc
     */
    public showtc() {
        initComponents();
        fetch();
   ...
   String url = "jdbc:derby://localhost:1527/C:/Derby/mydb";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showtc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
